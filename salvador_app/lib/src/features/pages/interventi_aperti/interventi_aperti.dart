...
String? _lastSelectedMonth; // Variabile globale o di classe per memorizzare la selezione
...
void _showMonthSelector(BuildContext context, WidgetRef ref) {
  ...
  ScrollController scrollController = ScrollController(
    initialScrollOffset: selectedMonthIndex >= 0 ? selectedMonthIndex * 40.0 : 0.0, // Altezza stimata per ogni ListTile
  );
                  ...
                  try {
                    ...
                    for (int i = 0; i < 3; i++) {
                      ...
                      List<Intervento> interventiMese = await ref
                          ...
                          .getInterventiPerMeseSelezionato(year, monthIndex);

                      interventiTotali.addAll(interventiMese);
                    }

                    // Aggiorna lo stato con gli interventi raccolti
                    ref.read(interventiStateRepositoryProvider.notifier).updateInterventiErp(interventiTotali);
                  } catch (e) {
